...
const variantStyles = {
  ...
  error: {
    ...
    icon: <AlertCircle className="h-5 w-5 text-red-700 dark:text-red-400" />,
  },
  warning: {
    container: "bg-yellow-50 border-yellow-200 text-yellow-900 dark:bg-yellow-900/20 dark:border-yellow-800 dark:text-yellow-300",
  ...
  info: {
    ...
    icon: <Info className="h-5 w-5 text-blue-700 dark:text-blue-400" />,
  },
};
